...
<body class="font-sans bg-[#FFF8F5] text-[#4C2A36]">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-6 w-full">
                <div class="max-w-xl text-left text-white">
                    <h1 class="text-4xl md:text-5xl font-bold mb-4 text-[#FFD1DC]">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a class="px-4 py-2 bg-[#5B3F4E] text-white rounded hover:bg-[#4A2C35] transition
                         ...
                         sm:text-base sm:font-semibold sm:h-auto whitespace-nowrap" href="skinassessment.php">Take Skin Assessment</a>
                        <a class="px-4 py-2 border border-white text-white rounded hover:bg-white hover:text-[#916D7A] transition
                         text-sm font-normal h-[36px]
                         sm:text-base sm:font-semibold sm:h-auto whitespace-nowrap" href="appointment.php">Book Appointment</a>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="consultation.php" class="block p-6 border rounded bg-[#FFF8F5] shadow-sm hover:shadow-md transition">
                    <img src="./image/AestheticConsultation.jpg" class="w-full h-[200px] object-cover rounded mb-4 transform transition duration-300 hover:scale-105" />
                    <p class="font-semibold text-[#4C2A36]">Virtual & In-person Consultations</p>
                </a>

                <!-- Service 2 -->
                <a href="skinassessment.php" class="block p-6 border rounded bg-[#FFF8F5] shadow-sm hover:shadow-md transition">
                    <img src="./image/skinanalysis.jpg" alt="Skin Assessments" class="w-full h-[200px] object-cover rounded mb-4 transform transition duration-300 hover:scale-105" />
                    <p class="font-semibold text-[#4C2A36]">Skin Assessments</p>
                </a>

                <!-- Service 3 -->
                <a href="skincare_treatments.php" class="block p-6 border rounded bg-[#FFF8F5] shadow-sm hover:shadow-md transition">
                    <img src="./image/skincare2.webp" alt="Skincare Treatments" class="w-full h-[200px] object-cover rounded mb-4 transform transition duration-300 hover:scale-105" />
                    <p class="font-semibold text-[#4C2A36]">Personalized Skincares</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-[#FFF8F5]">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h2 class="text-2xl font-bold mb-8 text-[#BA9EA8]">Latest Treatments</h2>
    ...
    <section class="py-12 bg-[#FFF8F5]">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h2 class="text-2xl font-bold mb-8 text-[#BA9EA8]">Meet Our Doctors</h2>
            <div>
                <?php
