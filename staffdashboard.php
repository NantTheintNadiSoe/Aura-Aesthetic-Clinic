...
// Statistics queries (all roles can view)
...
<div class="min-h-screen bg-gradient-to-br from-[#EBD5DC] to-[#F7F3F5] flex">
        ...
        <nav class="flex-1">
            <ul class="space-y-2">
                ...
                <?php elseif ($role === 'Aesthetic Doctor'): ?>
                    ...
                    <li><a href="recommendationlist.php" class="flex items-center px-4 py-2 rounded hover:bg-[#F7F3F5] transition">Recommendation List</a></li>
                    <li><a href="treatmentlist.php" class="flex items-center px-4 py-2 rounded hover:bg-[#F7F3F5] transition">Treatment List</a></li>
                    <li><a href="consultationlist.php" class="flex items-center px-4 py-2 rounded hover:bg-[#F7F3F5] transition">Consultation List</a></li>
                    <li><a href="skinassessmentlist.php" class="flex items-center px-4 py-2 rounded hover:bg-[#F7F3F5] transition">Skinassessment List</a></li>
                    <li><a href="patientlist.php" class="flex items-center px-4 py-2 rounded hover:bg-[#F7F3F5] transition">Patient List</a></li>
    ...
    <main class="flex-1 p-10 bg-gradient-to-br from-[#F7EFEF] to-[#EBD5DC] relative overflow-x-hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div class="bg-white rounded-2xl shadow-xl p-7 flex flex-col items-center border-b-4 border-[#916D7A]">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <a href="skinassessmentlist.php" class="bg-gradient-to-br from-[#EBD5DC] to-[#F7EFEF] hover:from-[#916D7A] hover:to-[#EBD5DC] hover:text-white transition rounded-2xl p-8 flex flex-col items-center shadow-xl group border border-[#EBD5DC]">
